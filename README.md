...
В результате выполнения лабораторной работы, я смог попрактиковаться в использование различных технологий и основных концепций функционального программирования. Также заметил на сколько на clojure код короче, чем на java.
